...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  const operationOrderIds = await db
    ...
    .values([
      { name: 'פעולה אלפא', date: '2026-03-01', time: '08:00:00' },
      { name: 'פעולה בטא', date: '2026-03-03', time: '06:00:00' },
      { name: 'פעולה גמא', date: '2026-03-05', time: '10:00:00' },
      { name: 'פעולה דלתא', date: '2026-03-08', time: '07:00:00' },
      { name: 'פעולה זטא', date: '2026-03-10', time: '09:00:00' },
      { name: 'פעולה חטא', date: '2026-03-12', time: '08:30:00' },
      { name: 'פעולה טטא', date: '2026-03-15', time: '06:30:00' },
      { name: 'פעולה יוד', date: '2026-03-17', time: '10:30:00' },
      { name: 'פעולה כף', date: '2026-03-20', time: '07:30:00' },
      { name: 'פעולה למד', date: '2026-03-22', time: '09:30:00' },
      { name: 'פעולה מם', date: '2026-03-25', time: '08:00:00' },
      { name: 'פעולה נון', date: '2026-03-27', time: '06:00:00' },
      { name: 'פעולה סמך', date: '2026-03-29', time: '10:00:00' },
      { name: 'פעולה עין', date: '2026-04-01', time: '07:00:00' },
      { name: 'פעולה פא', date: '2026-04-03', time: '09:00:00' },
      { name: 'פעולה צדי', date: '2026-04-05', time: '08:30:00' },
      { name: 'פעולה קוף', date: '2026-04-08', time: '06:30:00' },
      { name: 'פעולה ריש', date: '2026-04-10', time: '10:30:00' },
      { name: 'פעולה שין', date: '2026-04-12', time: '07:30:00' },
      { name: 'פעולה תו', date: '2026-04-15', time: '09:30:00' },
      { name: 'פעולה חירום 1', date: '2026-04-17', time: '00:00:00' },
      { name: 'פעולה חירום 2', date: '2026-04-20', time: '00:00:00' },
      { name: 'פעולה מיוחדת א', date: '2026-04-22', time: '08:00:00' },
      { name: 'פעולה מיוחדת ב', date: '2026-04-25', time: '06:00:00' },
      { name: 'פעולה מיוחדת ג', date: '2026-04-28', time: '10:00:00' },
    ])
    .returning('id')
    .execute();
